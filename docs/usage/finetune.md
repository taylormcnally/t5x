...
that fine-tunes a T5-small checkpoint on WMT benchmark is also showcased.
...
model is located at
[`/t5x/examples/t5/t5_1_1/small.gin`](https://github.com/google-research/t5x/tree/main/t5x/examples/t5/t5_1_0/small.gin),
...
For the example run, you will fine-tune the model on the WMT benchmark, which
