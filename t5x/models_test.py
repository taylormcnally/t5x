...
class EncoderDecoderModelTest(parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      dict(testcase_name='no_force_decoding', force_decode_inputs=False),
      dict(testcase_name='force_decoding', force_decode_inputs=True),
  )
  def test_force_decode_input(self, force_decode_inputs):
    ...
    model.predict_batch_with_aux({},
                                 batch,
                                 force_decode_inputs=force_decode_inputs)
